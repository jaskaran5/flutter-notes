          ...
          children: [
              ...
              (index) => Padding(
                ...
                child: Row(
                  ...
                  children: [
                    ...
                    AppText(
                      text:
                          "\$${(Services.values.firstWhereOrNull((element) => element.serviceName.tr == servicesList[index].toString())?.servicesPrice.tr) ?? Services.funActivityOutHouse.servicesPrice.tr}",
                      style: AppStyles.ubGrey15W500,
                      maxLines: 1,
                      textAlign: TextAlign.start,
                    ),
            ...
            Row(
              ...
              children: [
                ...
                AppText(
                  text:
                      "\$${childCount == 1 ? HourlyChildrenRateList.oneChild.ratePricePerChildren : childCount == 2 ? HourlyChildrenRateList.twoChildren.ratePricePerChildren : childCount == 3 ? HourlyChildrenRateList.threeChildren.ratePricePerChildren : childCount == 4 ? HourlyChildrenRateList.forChildren.ratePricePerChildren : '0.00'}",
                  style: AppStyles.ubGrey15W500,
                  maxLines: 1,
                  textAlign: TextAlign.start,
                ),
            ...
            Row(
              ...
              children: [
                ...
                AppText(
                  text:
                      "\$${double.parse(totalTimeHourPrice.toString()).toStringAsFixed(2)}",
                  style: AppStyles.ubGrey15W500,
                  maxLines: 1,
                  textAlign: TextAlign.start,
                ),
            ...
            if (serviceFees != 0.0) ...[
              Row(
                ...
                children: [
                  ...
                  AppText(
                    text:
                        '${addServiceFees ? "+" : "-"}\$${serviceFees.toStringAsFixed(2)}',
                    style: AppStyles.ubGrey15W500,
                    maxLines: 1,
                    textAlign: TextAlign.start,
                  ),
            ...
            if (adminCommission != 0.0) ...[
              Row(
                ...
                children: [
                  ...
                  AppText(
                    text: '-\$${adminCommission.toStringAsFixed(2)}',
                    style: AppStyles.ubGrey15W500,
                    maxLines: 1,
                    textAlign: TextAlign.start,
                  ),
