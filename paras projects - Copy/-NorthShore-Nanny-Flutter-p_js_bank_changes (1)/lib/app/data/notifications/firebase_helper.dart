...
//
  ...
  Future<void> showNotification(RemoteMessage message) async {
    ...
    await dashBoardBottomController.getNotificationCount();
    if (dashBoardBottomController.selectedTabIndex.value == 2) {
    ...
    if (dashBoardBottomController.selectedTabIndex.value == 0 &&
        logInType == StringConstants.nanny) {
    ...
    if (logInType == StringConstants.customer &&
        route == Routes.bookingDetailsView) {
      ...
      // }
        ...
        route == Routes.nannyBookingDetailsView) {
