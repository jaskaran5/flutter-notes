class ApiUrls {
  ...
  ///---------------------------------SOCKET URL
  ///used for staging socket url
  // static const String socketUrl = "https://api.northshore.harishparas.com/chat";

  /// used for release socket url
  static const String socketUrl = "https://api.thensnanny.com/chat";
  ...
  /// Release base url
  static const String baseUrl = "https://api.thensnanny.com/";

  /// this is staging url for add card success.
  // static const String addCardSuccess = "https://api.northshore.harishparas.com/paymentMethod/success";

  /// this is live url for add card success.
  static const String addCardSuccess =
      "https://api.thensnanny.com/paymentMethod/success";
  ...
  static const String getNannyForGuest = "api/NannyDashBoard/AllNannyList";
  ...
  static const String nannyDetailsForGuest = "api/NannyDashBoard/GetNannyProfile";
  ...
  static const String validateAppointment =
      "api/UserDashBoard/ValidateAppointment";
  ...
  static const String addOrEditVenmoDetails =
      'api/User/AddVenmoGaurdianDetails';
  static const String getVenmoAndGuardianDetails =
      'api/User/GetVenmoGaurdianDetails';
