...
class AppConstants {
  ...
  /// staging url "api.northshore.harishparas.com"

  /// release url "api.thensnanny.com"

  static const String aboutUsWebViewUrl =
      "https://api.thensnanny.com/StaticContent/About-us.html";
  static const String termsAndConditionWebViewUrl =
      "https://api.thensnanny.com/StaticContent/Terms-Conditions.html";
  static const String privacyPolicyWebViewUrl =
      "https://api.thensnanny.com/StaticContent/Privacy-Policy.html";
