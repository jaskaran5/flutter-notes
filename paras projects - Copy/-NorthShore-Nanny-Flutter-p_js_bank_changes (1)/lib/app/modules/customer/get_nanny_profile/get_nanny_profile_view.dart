...
class GetNannyProfileView extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    final isGuest = Get.arguments != null &&
            (Get.arguments as Map).containsKey("from")
        ? Get.arguments['from'] == Routes.nanniesForGuestUser
        : false;
    return GetBuilder(
                ...
                child: Column(
                  children: [
                          ...
                          Utility.openBottomSheet(CustomReviewBottomSheet(
                              ...
                              totalReviewsRating:
                                  controller.getNannyData?.rating == 0.0
                                      ? '0'
                                      : controller.getNannyData?.rating
                                              ?.toStringAsFixed(1) ??
                                          '0',
                              reviewsList:
                    ...
                    if (controller.selectedIndex == 2) ...[
                      ...
                      availabilityView(
                          controller: controller, isGuest: isGuest),
                    ],
                  ],
                ),
              ),
        ...
        children: List.generate(
          ...
          (index) => SizedBox(
            ...
            child: Card(
              ...
              elevation: 0.5,
              shadowColor: AppColors.lightNavyBlue.withValues(alpha: .8),
              child: Padding(
                    ...
                    Row(
                      ...
                      children: [
                        Padding(
                          ...
                          child: AppText(
                            text:
                                '\$${(Services.values.firstWhereOrNull((element) => element.serviceName == servicesList?[index].toString())?.servicesPrice.tr) ?? Services.funActivityOutHouse.servicesPrice.tr}',
                        ...
                        GestureDetector(
                          onTap: () {
                            Get.bottomSheet(
                              ...
                              barrierColor: AppColors.greyColor.withValues(alpha: .2),
                            );
                          },
                          child: SvgPicture.asset(
...
Widget availabilityView(
    {required GetNannyProfileController controller, required bool isGuest}) {
  return Padding(
    padding: Dimens.edgeInsetsL16R16,
    child: Column(
      mainAxisSize: MainAxisSize.min,
      ...
      children: [
        ...
        if (controller.selectedDate != null &&
            ...
            controller.singleDay?.data?.bookingDetail != null && !isGuest)
          CustomButton(
            title: TranslationKeys.bookSitter.tr,
            backGroundColor: AppColors.navyBlue,
            onTap: () {
              if (controller.getNannyData?.isAvailable == true) {
                controller.redirectToNannyScheduleView();
              } else {
                /// used to show this message because nanny is not available on that time,
                toast(
                    msg: 'Nanny is not available at this time', isError: true);
              }
            },
          ),
        Dimens.boxHeight5,
