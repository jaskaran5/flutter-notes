                  ...
                  child: SingleChildScrollView(
                    child: Column(
                      children: [
                        ...
                        /** SELECT LOCATION */
                        TextField(
                          readOnly: controller.isDisableLocationField,
                          controller: controller.locationTextEditingController,
                          maxLines: 1,
                          minLines: 1,
                          onChanged: (value) {
                            if (value.isEmpty) {
                              controller.isDisableLocationField = true;
                              controller.update();
                            }
                          },
                          decoration: customFieldDeco(
                ...
                CustomButton(
                  ...
                  onTap: () {
                    ...
                    controller.editProfileValidator(
                        ...
                        lastName: controller.lastNameTextEditingController.text,
                        phoneNumber:
