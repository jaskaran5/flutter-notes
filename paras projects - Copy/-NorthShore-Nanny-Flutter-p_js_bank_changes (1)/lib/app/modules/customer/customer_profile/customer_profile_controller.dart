...
class CustomerProfileController extends GetxController {
  ...
  /// used to disable or enable the location text Field.
  bool isDisableLocationField = false;
  ...
  updateLocationAddress({
    ...
    city = cityAddress;
    state = stateAddress;
    log('lat , long >>> $lat, $long  $cityAddress $stateAddress');
    update();
  }

  /// validator for customer edit profile.
  void editProfileValidator({
    required String firstName,
    required String lastName,
    required String phoneNumber,
    required String location,
  }) {
    var valid = Validator().customerCreateProfileValidator(
    ...
    if (valid) {
      ...
      toast(msg: Validator().error.toString(), isError: true);
    }
  }
}
