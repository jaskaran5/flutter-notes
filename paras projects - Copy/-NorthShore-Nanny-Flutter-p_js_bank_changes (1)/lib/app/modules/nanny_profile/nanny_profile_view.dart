                      ...
                      Utility.openBottomSheet(CustomReviewBottomSheet(
                          ...
                          totalReviewsRating:
                              controller.profileData.data?.rating == 0.0
                                  ? '0'
                                  : controller.profileData.data?.rating
                                          ?.toStringAsFixed(1) ??
                                      '0',
                          reviewsList:
      ...
      child: Column(
        ...
        children: [
          Container(
            ...
            child: TableCalendar(
              ...
              onDaySelected: (selectedDay, focusedDay) {
                ...
                log('Local==>selected Date:${selectedDay.toIso8601String()}');
                log('UTC ==> selected Date:${selectedDay.toUtc().toIso8601String()}');
          ...
          controller.singleDay?.data != null && controller.selectedDate != null
              ? availabilityTime(controller.singleDay, controller)
          ...
          if (!controller.isElementEqualToData(
            ...
            DateFormat("yyyy-MM-dd HH:mm:ss")
                    .tryParse(
                        controller.singleDay?.data?.openingTime?.toString() ??
                            "",
                        true)?.toLocal()
                    .day ??
                0,
...
Widget availabilityTime(
    AvailabilityByDayModel? singleDay, NannyProfileController controller) {
  final openingTime = singleDay?.data?.openingTime;
  final closingTime = singleDay?.data?.closingTime;
  return Container(
    padding: Dimens.edgeInsets16,
    decoration: BoxDecoration(
      color: AppColors.primaryColor,
    ...
    child: Row(
      ...
      children: [
        Row(
          ...
          children: [
            AppText(
              text: Utility.getDay(dateTime: openingTime),
            ...
            Column(
              ...
              children: [
                ...
                AppText(
                  text:
                      '${Utility.formatTimeTo12Hour(openingTime.toString())}  to ${Utility.formatTimeTo12Hour(closingTime.toString())}',
                  style: AppStyles.ubBlack14W700,
                  maxLines: 1,
                  textAlign: TextAlign.start,
                )
                                    ...
                                    child: Column(
                                      ...
                                      children: [
                                        TextField(
                                          ...
                                          decoration: customFieldDeco(
                                            hintStyle: AppStyles.ubBlack15W600,
                                            hintText: nannyController
                                                        .startTime ==
                                                    null
