                ...
                children: [
                  ...
                  CustomBookingDetailView(
                    ...
                    time: controller.bookingDataById?.openingDate != null
                        ...
                        : '',
                    location:
                        controller.bookingDataById?.userDetails?.location.toString() ?? '',
                      ...
                      expansionCallback: (index) {
                        if (controller
                            ...
                            controller.bookingDataById?.children?[index]
                                ...
                                true ||
                            controller.bookingDataById?.children?[index]
                                    .aboutChild?.isNotEmpty ==
                                true) {
                          controller.bookingDataById?.children?[index]
                              .isExpand = !(controller
                                  .bookingDataById?.children?[index].isExpand ??
                              false);
                          controller.update();
                        }
                      },
                  ...
                  GetBuilder<BookingDetailController>(
                    ...
                    builder: (trackingController) => trackingController
                      ...
                      secondWidget: const SizedBox.shrink(),
                  ...
                  CustomBookingReceiptTile(
                    ...
                    totalPriceReceived:
                        ((controller.bookingDataById?.totalAmount ?? 0.0)
                            // +
                            //     (controller.bookingDataById?.serviceFees ??
                            //         0.0)
                            )
                            .toStringAsFixed(2),
                    ...
                    servicesList:
                        controller.bookingDataById?.servicesType ?? [],
                    totalTimeHour: controller.bookingDataById?.totalHour ?? 0,
                    totalTimeHourPrice:
                        controller.bookingDataById?.hourlyPrice ?? 0,
                    isReferralBonus:
                    ...
                    netPayBalAmount:
                        controller.bookingDataById?.isUseReferrals == true
                            ? (controller.bookingDataById?.totalAmount ?? 0.0) -
                                5.0
                            : 0.0,
                    serviceFees: controller.bookingDataById?.serviceFees ?? 0.0,
                  ),
                  Dimens.boxHeight16,
                  if ((controller.bookingDetailStatus ==
