...
import '../dashboard_bottom/dashboard_bottom_binding.dart';
        ...
        if (response.response == AppConstants.apiResponseSuccess) {
          ...
          if (response.data?.bookingStatus == 7 &&
            ...
            Utility.showAlertDialog(
              ...
              showContentSvg: true,
              message:
                  'Your Job is complete. Please rate your experience with this sitter.',
            );
          }
        } else {
  ...
  updateStatus({
    ...
    try {
      ...
      _apiHelper
        ...
        if (response.response == AppConstants.apiResponseSuccess) {
          getBookingDataById(bookingId: response.data?.bookingId ?? 0);
          update();
        } else {
          toast(msg: response.message.toString(), isError: true);
        }
