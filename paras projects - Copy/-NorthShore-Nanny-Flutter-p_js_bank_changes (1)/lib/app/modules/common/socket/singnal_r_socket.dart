...
class SignalRHelper {
  ...
  Future<void> init() async {
    ...
    Utils.printLog("access token :--->> $token");
    Utils.printLog("access token :--->> $token");
  ...
  Future<void> startConnection() async {
    Utils.printLog("start scoket connection called");
    Utils.printLog("hubconnectionn state:--->>${hubConnection.state}");

    try {
      Utils.printLog("hubconnectionn state try:--->>${hubConnection.state}");
      ...
      Utils.printLog("hubconnectionn state else:--->>${hubConnection.state}");
