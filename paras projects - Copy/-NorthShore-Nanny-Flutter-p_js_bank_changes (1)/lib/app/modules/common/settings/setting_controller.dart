...
class SettingController extends GetxController {
  ...
  final customerSettingList = [
    ...
    {
      "name": TranslationKeys.mangeChildrenProfiles.tr,
  ...
  final nannySettingList = [
    /***m venmo DETAILS */
    {
      "name": TranslationKeys.venmoDetails.tr,
    ...
    try {
      ...
      _apiHelper.postApi(ApiUrls.customerLogOut, null).futureValue((value) {
        ...
        if (response.response == AppConstants.apiResponseSuccess) {
          ...
          Get.delete<DashboardBottomController>(force: true);
  ...
  /// used to check type of venmo or guardian
  RxBool isVenmoDetailAdded = false.obs;
