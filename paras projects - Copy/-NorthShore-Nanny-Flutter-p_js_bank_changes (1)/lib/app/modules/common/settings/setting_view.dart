        ...
        return CustomSettingItemTile(
          onTap: () {
            ...
            if (index == 0) {
              ...
              /** RATE A APP   And appStoreId id is used for ios */
              final InAppReview inAppReview = InAppReview.instance;
              inAppReview.openStoreListing(
                appStoreId: '6499265992',
              );
            } else if (index == 8) {
              ...
              Utility.showAlertDialog(
                ...
                secondButtonBackgroundColor:
                    AppColors.fC3030RedColor.withValues(alpha: .1),
      ...
      itemBuilder: (context, index) {
        return CustomSettingItemTile(
          onTap: () async {
            log("index: $index");
            if (index == 0) {
              debugPrint('venmo detail ${controller.isVenmoDetailAdded}');
              // RouteManagement.goToUpdateBankDetailView();
              RouteManagement.goToVenmoDetailView(
                isHaveVenmo: controller.isVenmoDetailAdded.value,
                isComeFromEdit: true,
              );
              /** BANK DETAILS */
            } else if (index == 1) {
              ...
              /** RATE A APP AND appstore id is used for ios */
              final InAppReview inAppReview = InAppReview.instance;
              inAppReview.openStoreListing(
                appStoreId: '6499265992',
              );
