              ...
              child: Padding(
                ...
                child: Column(
                  ...
                  children: [
                          ...
                          Container(
                            ...
                            decoration: BoxDecoration(
                              ...
                              boxShadow: [
                                BoxShadow(
                                  color:
                                      AppColors.lightNavyBlue.withValues(alpha: .8),
                            ...
                            child: Container(
                              decoration: BoxDecoration(
                                ...
                                boxShadow: [
                                  BoxShadow(
                                    color:
                                        AppColors.greyColor.withValues(alpha: 0.05),
                    ...
                    TextField(
                      maxLength: 20,
                      readOnly: controller.isAppleLogIn.value && controller.firstNameTextEditingController.text.isNotEmpty,
                    ...
                    TextField(
                      maxLength: 20,
                      readOnly: controller.isAppleLogIn.value && controller.lastNameTextEditingController.text.isNotEmpty,
                    ...
                    /** ------------------------------->>>>>>>>>>>>>>>>>>> LOCATION */
                    TextField(
                      readOnly: controller.isLocationFieldDisable,
                      controller: controller.locationTextEditingController,
                      onChanged: (value) {
                        if (value.isEmpty) {
                          controller.isLocationFieldDisable = true;
                          controller.update();
                        }
                      },
                      maxLines: 1,
