      ...
      GetBuilder<CreateNannyProfileController>(
        ...
        builder: (controller) => Scaffold(
          ...
          appBar: CustomAppbarWidget(
            ...
            onBackPress: () {
              Get.back();
              controller.deleteBankDetailTextEditingControllers();
            },
          ),
                    ...
                    child: Padding(
                      ...
                      child: Column(
                        ...
                        children: [
                          ...
                          TextField(
                            controller:
                                controller.sSnNumberTextEditingController,
                            maxLines: 1,
                            minLines: 1,
                            maxLength: 9,
                            decoration: customFieldDeco(
                              hintText: TranslationKeys.ssnLast4.tr,
                              prefixWidget: Padding(
                                padding: Dimens.edgeInsets12,
                                child: SvgPicture.asset(
                                  Assets.iconsPostalCode,
                          ...
                          Dimens.boxHeight20,
                          controller.pickedFrontImage == null ||
                                  controller.pickedFrontImage?.path.isEmpty ==
                                      true
                              ? GestureDetector(
                                  onTap: () {
                                    /// used to pick Front image
                                    controller.pickFrontImage();
                                  },
                                  child: SvgPicture.asset(
                                    Assets.iconsFrontSide,
                                    width: Get.width,
                                  ),
                                )
                              : ClipRRect(
                                  ...
                                  child: Image.file(
                                    File(controller.pickedFrontImage?.path ??
                                        ''),
                          ...
                          Dimens.boxHeight20,
                          controller.pickedBackImage == null ||
                                  controller.pickedBackImage?.path.isEmpty ==
                                      true
                              ? GestureDetector(
                                  onTap: () {
                                    /// used to pick back image
                                    controller.pickBackImage();
                                  },
                                  child: SvgPicture.asset(
                                    Assets.iconsBackSide,
                                    width: Get.width,
                                  ))
                              : ClipRRect(
                                  borderRadius:
                                      BorderRadius.circular(Dimens.nine),
                                  child: Image.file(
                                    File(
                                        controller.pickedBackImage?.path ?? ''),
                                    height: Dimens.oneHundredSixty,
                                    width: Get.width,
                                    fit: BoxFit.fill,
                                  ),
