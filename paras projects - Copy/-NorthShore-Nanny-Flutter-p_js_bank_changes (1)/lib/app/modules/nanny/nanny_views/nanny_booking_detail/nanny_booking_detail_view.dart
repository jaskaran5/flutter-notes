...
class NannyBookingDetailView extends GetView<NannyBookingDetailController> {
                  ...
                  children: [
                    if (controller.nannyBookingDetailStatus ==
                        ...
                        controller.nannyBookingDetailStatus ==
                            ...
                            controller
                                    .bookingDetailsModel?.data?.isJobStarted ==
                                true) ...[
                      GetBuilder<NannyBookingDetailController>(
                        id: 'timerView',
                        builder: (timerController) => Container(
                          ...
                          child: Column(
                            ...
                            children: [
                              ...
                              AppText(
                                text:
                                    timerController.bookingDetailsModel?.data
                                                ?.endTime !=
                                            null
                                        ? Utility.calculateTotalTimeDifference(
                                            timerController.bookingDetailsModel
                                                ?.data?.startTime,
                                            timerController.bookingDetailsModel
                                                ?.data?.endTime)
                                        : Utility.returnHMS(
                    ...
                    CustomBookingDetailView(
                      ...
                      time: controller.bookingDetailsModel?.data?.openingDate !=
                          ...
                          : '',
                      location: controller.bookingDetailsModel?.data?.userDetails?.location
                              .toString() ??
                          '',
                      ...
                      expansionCallback: (index) {
                        if (controller
                            ...
                            controller.bookingDetailsModel?.data
                                    ?.children?[index].aboutChild?.isNotEmpty ==
                                true) {
                                    ...
                                    GestureDetector(
                                      ...
                                      child: Row(
                                        ...
                                        children: [
                                          ...
                                          AppText(
                                            text:
                                                '(${trackController.bookingDetailsModel?.data?.userDetails?.reviewCount ?? '0'} ${TranslationKeys.reviews.tr})',
                    ...
                    CustomBookingReceiptTile(
                      ...
                      totalTimeHourPrice: controller
                              .bookingDetailsModel?.data?.hourlyPrice
                              .toString() ??
                          '0',
                      adminCommission: controller
                              .bookingDetailsModel?.data?.adminCommission ??
                          0.0,
                    ),
                    Dimens.boxHeight14,
                      ...
                      Row(
                        ...
                        children: [
                          CustomButton(
                            ...
                            backGroundColor:
                                AppColors.fC3030RedColor.withValues(alpha: .15),
                                                                ...
                                                                children: [
                                                                  ...
                                                                  AppText(
                                                                    text: bookingController
                                                                        ...
                                                                        .toString(),
                                                                    maxLines: 1,
                                                                    style: bookingController.selectedIndex ==
                                                                            index
                                                                        ? AppStyles
                                                                            .ubNavyBlue14W600
                                                                        : AppStyles
                    ...
                    if ((controller.nannyBookingDetailStatus ==
                      ...
                      Opacity(
                        opacity: (controller.bookingDetailsModel?.data
                                            ?.isJobStarted ==
                                        true &&
                                    controller.nannyBookingDetailStatus ==
                                        NannyBookingDetailStatus.onMyWay) ||
                          ...
                          onTap: () {
                            if (controller.nannyBookingDetailStatus ==
                              ...
                              controller.updateStatus(
                                  bookingId: controller.bookingDetailsModel
                                          ?.data?.bookingId ??
                                      0,
                                  bookingStatus: 4);
                                ...
                                onTap: () {
                                  Utility.openBottomSheet(
                                    const CustomBottomSheet(
                                        ...
                                        description:
                                            'We are waiting for the family to confirm that the job was completed. If they don\'t confirm in the next eight hours, the job will be automatically marked as complete, and you will have the option to rate and write a review.'),
                                  );
                                },
