...
import 'package:northshore_nanny_flutter/app/modules/common/rating_and_review/rating_review_view.dart';
...
import 'package:northshore_nanny_flutter/app/modules/nanny/nanny_views/venmo/venmo_and_guardian_details_view.dart';
import 'package:northshore_nanny_flutter/app/modules/nanny/nanny_views/venmo/venmo_binding.dart';
import 'package:northshore_nanny_flutter/app/modules/nanny/nanny_views/venmo/venmo_view.dart';
...
import '../app/modules/common/rating_and_review/rating_and_review_binding.dart';
...
import '../app/modules/guest_module/guest_user_controller.dart';
import '../app/modules/guest_module/nannies_for_guest_user.dart';
...
class AppPages {
  ...
  static final pages = [
    ...
    GetPage<VenmoView>(
      name: Routes.venmoView,
      transitionDuration: transitionDuration,
      page: VenmoView.new,
      binding: VenmoBinding(),
      transition: Transition.rightToLeft,
    ),
    GetPage<VenmoAndGuardianDetailsView>(
      name: Routes.venmoDetailView,
      transitionDuration: transitionDuration,
      page: VenmoAndGuardianDetailsView.new,
      binding: VenmoBinding(),
      transition: Transition.rightToLeft,
    ),
    ...
    /** --- REDIRECT TO ------ Customer Tracking View to Booking  -------  */
    GetPage<NanniesForGuestUser>(
      name: Routes.nanniesForGuestUser,
      transitionDuration: transitionDuration,
      page: NanniesForGuestUser.new,
      binding: GuestUserControllerBinding(),
      transition: Transition.leftToRight,
    ),
  ];
}
