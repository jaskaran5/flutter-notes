...
abstract class RouteManagement {
  ...
  /// go To Venmo screen from pricing services .
  static void goToVenmoView() {
    Get.toNamed<void>(
      Routes.venmoView,
    );
  }

  /// go To Venmo Detail view from Venmo screen .
  static void goToVenmoDetailView({bool? isHaveVenmo, bool? isComeFromEdit}) {
    Get.toNamed<void>(
      Routes.venmoDetailView,
      arguments: {
        "isHaveVenmo": isHaveVenmo,
        "isComeFromEdit": isComeFromEdit,
      },
    );
  }
  ...
  /// Go to GET NANNY PROFILE  View
  static void goToNanniesForGuestUserView({argument}) {
    Get.toNamed(Routes.nanniesForGuestUser, arguments: argument ?? 0);
  }
